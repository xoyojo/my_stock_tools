...
def align_stock_data_to_trading_calendar(stock_df, start_date, end_date):
    ...
    stock_df['trade_date'] = stock_df.index.strftime('%Y-%m-%d')
...
def align_reprot_data_to_trading_calendar(stock_code,
    ...
    all_reports = fetch_data.get_hist(reports_dump)
...
if __name__ == "__main__":
    ...
    stock_data = fetch_data.fetch_hist(
    ...
    bb_df = align_reprot_data_to_trading_calendar(
        '600519', start_date='2018-08-06', end_date='2022-03-29', reports_dump='reports-2020-2023')
